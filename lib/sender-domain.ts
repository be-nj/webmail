/**
 * Domain helpers shared by the server routes that look things up per sender
 * domain (favicon, BIMI). Server-only: the multi-part TLD list is too big to
 * ship to the browser for no reason.
 */
